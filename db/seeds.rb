...
loco = Establishment.new(name: "Loco By Jem's", address: "293 rue d'Ornano Bordeaux", phone_number: "05 56 55 99 37", description: "Cuisine bistro le midi et gastronomique le soir exclusivement faites avec des produits frais et de saisons.", category: :restaurant, access_average: 5, service_average: 5)
...
exploit = Establishment.new(name: "L'Exploit", address: "29 quai des Chartrons Bordeaux", phone_number: "05 57 59 92 82", description: "Un bistrot comme il en reste peut ! Les patrons adorables et cuisine délicieuse.", category: :restaurant, access_average: 3, service_average: 4)
...
phenix = Establishment.new(name: "Phénix d'Or", address: "17 rue des Frères Bonie Bordeaux", phone_number: "05 56 44 91 05", description: "Une cuisine vietnamienne de très bonne qualité, avec une jolie terrasse.", category: :restaurant, access_average: 4, service_average: 5)
...
peppone = Establishment.new(name: "Chez Peppone", address: "Cours Georges Clémenceau Bordeaux", phone_number: "05 56 44 91 05", description: "Excellents produits gentiment servis. Cochon, vins, fromages et glaces d'un bon rapport qualité prix.", category: :restaurant, access_average: 2, service_average: 4)
...
creperie = Establishment.new(name: "Crêperie Gourmands", address: "172 rue Sainte Catherine Bordeaux", phone_number: "06 87 75 61 60", description: "Un voyage gustatif qui vous transporte dans les spécialités brestoise, dégustez un sucré ou salé tout est fait pour se régaler.", category: :restaurant, access_average: 3, service_average: 3)
...
blanche = Establishment.new(name: "Terrasse de la Croix Blanche", address: "62 rue de la Croix Blanche Bordeaux", phone_number: "06 61 60 05 61", description: "Passez une soirée sur le thème de la cuisine française, diversifiée ou traditionnelle et découvrez ses diverses facettes.", category: :restaurant, access_average: 5, service_average: 4)
...
carnot = Establishment.new(name: "L'Avenue Carnot", address: "2 avenue Carnot Bordeaux", phone_number: "05 56 02 20 27", description: "En poussant le portail de l’Avenue Carnot, la première impression est d’entrer dans une maison paisible et chaleureuse.", category: :restaurant, access_average: 4, service_average: 3)
...
mots = Establishment.new(name: "Mets Mots", address: "98 rue Fondaudège Bordeaux", phone_number: "05 57 83 38 24", description: "Depuis sa cuisine ouverte Léo Forget et son équipe livrent leurs idées du moment qui font la part belle aux produits frais de saisons.", category: :restaurant, access_average: 3, service_average: 4)
...
cruege = Establishment.new(name: "Julien Cruège", address: "245 rue Turenne Bordeaux", phone_number: "05 56 81 97 86", description: "Décor contemporain, chic et spacieux, ce restaurant, offre un cadre idéal pour se régaler d'une cuisine créative et savoureuse.", category: :restaurant, access_average: 3, service_average: 3)
...
ferreti = Establishment.new(name: "Casa Ferreti", address: "230 avenue du Maréchal de Lattre de Tassigny Bordeaux", phone_number: "05 35 54 45 54", description: "Pizzas, pâtes, antipasti, ravioles, desserts...Retrouvez les vraies saveurs de l’Italie dans votre assiette.", category: :restaurant, access_average: 4, service_average: 4)
...
palais = Establishment.new(name: "Au Bonheur du Palais", address: "74 rue Paul Louis Lande Bordeaux", phone_number: "05 56 94 38 63", description: "Toujours exemplaire et initiatique la cuisine des frères Shan dans ce coin paisible du centre ville.", category: :restaurant, access_average: 3, service_average: 5)
...
cantine = Establishment.new(name: "Cantine Gourmande", address: "2 bis rue Flornoy Bordeaux", phone_number: "09 81 84 69 12", description: "Concept original dans le quartier, idéal pour manger des produits frais bien cuisinés.", category: :restaurant, access_average: 4, service_average: 4)
...
sommelier = Establishment.new(name: "Le Bistro du Sommelier", address: "163 rue Georges Bonnac Bordeaux", phone_number: "05 56 96 71 78", description: "Institution à bordeaux pour les amateurs de plats canailles et roboratifs, belle carte des vins.", category: :restaurant, access_average: 4, service_average: 4)
...
bastide = Establishment.new(name: "Café Bastide", address: "69 allée Serr Bordeaux", phone_number: "05 56 86 83 31", description: "Au cœur de la Bastide, quartier historique de la rive droite bordelaise, cuisine moderne et gourmande.", category: :restaurant, access_average: 4, service_average: 2)
...
puts "Create bars"
jaquen = Establishment.new(name: "Jaquen Craft Beer", address: "5 rue Beaubadat Bordeaux", phone_number: "06 48 14 00 38", description: "Super adresse, très bonne ambiance, le service est impeccable et des bières artisanales vraiment très bonnes.", category: :bar, access_average: 3, service_average: 4)
...
kingkong = Establishment.new(name: "King Kong Bar", address: "72 quai des Chartrons Bordeaux", phone_number: "05 56 79 25 89", description: "Des cocktails, des barmen et une ambiance de folie! N’attendez plus et tester le meilleur bar de Bordeaux!", category: :bar, access_average: 2, service_average: 3)
...
cocoloko = Establishment.new(name: "Coco Loko", address: "3 rue Duffour Dubergier Bordeaux", phone_number: "06 98 81 58 52", description: "This is the place to be crazy !! Comme son nom l’indique, le Coco Loko est le bar de Bordeaux où l’ambiance est la plus folle !", category: :bar, access_average: 4, service_average: 3)
...
centralpub = Establishment.new(name: "The Central Pub", address: "Rue Reignier Bordeaux", phone_number: "05 57 80 38 00", description: "The Central Pub a été créé en 2004 à l'intérieur de l'ancienne gare d'Orléans, bâtiment classé Monument de France.", category: :bar, access_average: 4, service_average: 4)
...
makila = Establishment.new(name: "Makila Kafe", address: "Quai de Bacalan Bordeaux", phone_number: "05 57 87 33 21", description: "Situé sur le Quai de Bacalan, en plein centre-ville de Bordeaux, le restaurant Makila Kafé vous ouvre ses portes en bord de Garonne dans un cadre idyllique.", category: :bar, access_average: 3, service_average: 2)
...
mashup = Establishment.new(name: "Mashup", address: "23 rue des Piliers de Tutelle Bordeaux", phone_number: "05 56 87 67 95", description: "Lieu incontournable des amateurs de bières et de babyfoot. Oubliez la Heineken et dégustez une Paix Dieu! De la vraie bière quoi!", category: :bar, access_average: 2, service_average: 3)
...
# opera = Establishment.new(name: "Opéra National de Bordeaux", address: "Place de la Comédie Bordeaux", phone_number: "05 56 00 85 95", description: "Inauguré le 7 avril 1780, le Grand-Théâtre de Bordeaux écrit son histoire au rythme des événements qui ponctuent son existence.", category: :theatre, access_average: 4, service_average: 4)
...
puts "Create cinema"
megarama = Establishment.new(name: "Megarama", address: "7 allée Serr Bordeaux", phone_number: "05 56 40 66 70", description: "Situé dans l’ancienne Gare d’Orléans, le cinéma Mégarama est un très grand cinema au bord de Garonne avec de très belles salles.", category: :cinema, access_average: 5, service_average: 4)
...
utopia = Establishment.new(name: "Utopia", address: "5 place Camille Jullian Bordeaux", phone_number: "05 56 52 00 03", description: "Face à une petite place coquette, une ancienne église transformée en café/cinéma plutôt original et atypique.", category: :cinema, access_average: 3, service_average: 3)
...
francaiscgr = Establishment.new(name: "CGR Le Français", address: "9 rue Montesquieu Bordeaux", phone_number: "0 892 688 588", description: "Avant d’être le cinéma Le Français, ce beau bâtiment situé dans le quartier Gambetta et réalisé par l’architecte Jean-Baptiste Dufart, avait pour vocation le théâtre.", category: :cinema, access_average: 4, service_average: 5)
